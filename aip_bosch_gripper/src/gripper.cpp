...
namespace aip_bosch_gripper
{
    ...
    void Gripper::open_gripper(const std::shared_ptr<std_srvs::srv::Trigger::Request>,
    ...
    void Gripper::close_gripper(const std::shared_ptr<std_srvs::srv::Trigger::Request>,
                                std::shared_ptr<std_srvs::srv::Trigger::Response> response)
    {
        rclcpp::Rate loop_rate(50);
